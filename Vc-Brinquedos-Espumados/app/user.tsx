...
import Nav from '../components/nav-bar';
 ...
 const User = ({fullName, email, password, CPF, socialReason, StateRegistration, CNPJ, CEP, UF, city, neighborhood, road, numberHouse, complement, numberPhone, dateOfBirth} : 
